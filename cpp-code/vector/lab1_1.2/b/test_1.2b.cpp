...
static class TestDescription_suite_MyTestSuite_test_a_is_last : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_MyTestSuite_test_a_is_last() : CxxTest::RealTestDescription( Tests_MyTestSuite, suiteDescription_MyTestSuite, 24, "test_a_is_last" ) {}
 void runTest() { suite_MyTestSuite.test_a_is_last(); }
} testDescription_suite_MyTestSuite_test_a_is_last;
