...
public class SimpleActionWithTransRequest{
    public Maapi maapi;
    public Socket s;
    ...
    private static Logger LOGGER = Logger.getLogger(SimpleActionRequest.class);

    public SimpleActionWithTransRequest(){
    ...
    public void go(){
        ...
        try{
            ...
            ConfXMLParam[] res =
                maapi.requestActionTh(th, params, "/testalarms/purge-alarms");
