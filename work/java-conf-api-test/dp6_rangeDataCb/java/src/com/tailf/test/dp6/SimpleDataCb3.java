...
public class SimpleDataCb3 {

    private static Logger LOGGER = Logger.getLogger(SimpleDataCb3.class);
    ...
    @DataCallback(callPoint="simplecp", callType=DataCBType.ITERATOR)
        ...
        return SimpleWithTrans2.iterator();
    }
    ...
    public ConfValue getElem(DpTrans trans, ConfObject[] kp)
        ...
        Server s = SimpleWithTrans2.findServer( name );
    ...
    @DataCallback(callPoint="simplecp", callType=DataCBType.NUM_INSTANCES)
        ...
        return SimpleWithTrans2.numServers();
    }
