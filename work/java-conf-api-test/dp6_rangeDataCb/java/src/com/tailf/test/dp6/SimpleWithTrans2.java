...
public class SimpleWithTrans2 {
    ...
    private static Logger LOGGER = Logger.getLogger(SimpleWithTrans2.class);
    ...
    static public void main(String args[]) {
        ...
        try {
            ...
            SimpleTransCb2 trans_cb = new SimpleTransCb2();
            SimpleDataCb3 data_cb = new SimpleDataCb3();

            /* create new control socket */
            Socket ctrl_socket= new Socket("127.0.0.1",Conf.PORT);

            /* init and connect the control socket */
            dp = new Dp("server_daemon2",ctrl_socket);
            // Dp dp = new Dp("server_daemon2",ctrl_socket);

            /* register the callbacks */
            dp.registerAnnotatedCallbacks( trans_cb );
            dp.registerAnnotatedRangeDataCallbacks(
                                                   data_cb,
                                                   new ConfValue[] { new ConfBuf("g") },
                                                   new ConfValue[] { new ConfBuf("zzzz") },
