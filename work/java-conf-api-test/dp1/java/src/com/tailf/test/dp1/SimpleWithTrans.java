...
public class SimpleWithTrans {
     ...
     * Renames a DB file
     */
    public synchronized static void rename(String oldname,
                                           String newname)
    ...
    static public void main(String args[]) {
        ...
        try {
            ...
            SimpleAuthCb auth_cb = new SimpleAuthCb();
            ...
            dp.registerAnnotatedCallbacks( auth_cb );
            dp.registerDone();
