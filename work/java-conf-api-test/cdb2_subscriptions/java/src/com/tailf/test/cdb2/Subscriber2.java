...
public class Subscriber2 {
    ...
    private static Logger log = Logger.getLogger ( Subscriber2.class  );
    ...
    static class DiffIterateImpl implements CdbCLIDiffIterate {
                                                ...
                                                Object initstate )
        {
            ...
            log.info ( " op :"  + op );
            log.info ( " oldval:" + oldValue) ;
            log.info ( " newval:" + newValue) ;
            log.info ( " CliStr:" + cliStr) ;
            for ( ConfCLIToken tok : tokens )
                log.info ("tok:" + tok );
