...
public class test_nocand {
    ...
    private static Logger LOGGER = Logger.getLogger(test_nocand.class);
    static public void main(String args[]) {
        ...
        TestCase[] tests = new TestCase[] {
            ...
            new TestCase() {
                public void test() throws Exception {
                    LOGGER.info("initAdmin()");
                    initAdmin();
                    LOGGER.info("maapi.deleteConfig()");
                    try {
            ...
            new TestCase() {
                ...
                public DiffIterateResultFlag iterate(ConfObject[] kp,
                    ...
                    System.out.println("kp[0]:" + kp[0].toString());
                    System.out.println("path:" + new ConfPath(kp).toString());

                    if (((ConfTag)kp[0]).getTagHash() == 585848417){
                        traversed_c_int8 = true;
                        long newVal1 = ((ConfInt8)newValue).intValue();
                        if (!(newVal1 == 42L)) {
                    ...
                    if (((ConfTag)kp[0]).getTagHash() == 10387472) {
                        traversed_port = true;
                        long newVal2 = ((ConfUInt16)newValue).intValue();
                        if (!(newVal2 == 8080L)) {
